# Time this with Measure-Command -Expression { .\conan-ccdc-index\full-rebuilds\windows-msvc17-x86_64.ps1 > .\rebuildall.log 2>&1 }
...
$Env:LCI_PLATFORM_COMBINATION="native-windows-msvc17-x86_64"
$Env:CONAN_USER_HOME="E:\conan-home-msvc17"
